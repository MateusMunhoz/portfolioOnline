...
const typewriterEl = document.getElementById('typewriterBio');
if (typewriterEl) {
    const text = 'Em busca de uma oportunidade de estágio para aplicar e expandir meus conhecimentos em desenvolvimento de software.';
    let i = 0;
    const speed = 20;
    function typeWriter() {
        if (i < text.length) {
